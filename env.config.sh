...
export SLAVE_MOUNT_PATH_NODE="/data/jenkins_slave_node"
export SLAVE_MOUNT_PATH_NODE_4="/data/jenkins_slave_node_4"
export SLAVE_MOUNT_PATH_JAVA="/data/jenkins_slave_node"
export SLAVE_MOUNT_PATH_ANSIBLE="/data/jenkins_slave_ansible"
#export SLAVE_MOUNT_PATH_NODE_LATEST="/local_data/jenkins_slave_node_latest"
#export SLAVE_MOUNT_PATH_NODE_LATEST_TEST="/local_data/jenkins_slave_node_latest_test"
